...
| [0027](0027-job-retry-semantics.md) | When a failed job runs again | A `P80Error` saying "not retryable" is believed; the backoff lives in the row, not in the worker | Accepted |

**All 27 ADRs are decided as of 2026-08-23. 0021 is superseded by 0025** — in part: 0025
