...
- **Dogfooding.** Spec §35 Stage 13 requires internal dogfooding, and §34.6 requires a
  proficient speaker to judge candidate quality. The person building this needs to be
...
**Target language:** _to be filled in_
**Native language:** _to be filled in_
